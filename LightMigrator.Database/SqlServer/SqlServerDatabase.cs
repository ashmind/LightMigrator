...
namespace LightMigrator.Database.SqlServer {
    ...
    public class SqlServerDatabase : IDatabase {
        ...
        public SqlServerDatabase([NotNull] string connectionString, [NotNull] Func<IDatabase, IDatabaseRollbackPlan> rollbackPlanFactory) {
        ...
        public IDatabaseRollbackPlan RollbackPlan { get; private set; }
            ...
            using (var command = connection.CreateCommand()) {
                ...
                foreach (var part in parts) {
                    try {
                        ...
                        throw new DatabaseMigrationException(ex.Message + Environment.NewLine + part, part, ex);
                    }
                }
            }
        ...
        private void AddArguments([NotNull] IDbCommand command, object arguments) {
            ...
            foreach (var property in properties) {
                ...
                try {
                    ...
                    // ReSharper disable once PossibleNullReferenceException
                    throw new DatabaseMigrationException(string.Format("Failed to read property {0} from {1}: {2}", property.Name, arguments, ex), ex);
                }
